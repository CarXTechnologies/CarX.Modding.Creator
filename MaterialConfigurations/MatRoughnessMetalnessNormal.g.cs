...
{
	/// <summary>
	/// Generated abstract material mapping for MAT_ROUGHNESS_METALNESS_NORMAL variant
	/// Implement mapping logic by deriving from this class and assigning the static 'mapping' field.
	/// </summary>
	public abstract class MatRoughnessMetalnessNormal
	{
		public static MatRoughnessMetalnessNormal mapping;

		protected MatRoughnessMetalnessNormal(MatRoughnessMetalnessNormal mapping)
		{
			MatRoughnessMetalnessNormal.mapping = mapping;
		}
		...
		{
			{
				Key_u_sTexture, new []{
					new MaterialData
					{
						propertyType = 4,
						propertyName = "map_Kd",
						action = ((n, v, m) => mapping.FromMapKd(n, (Texture2D)v, m))
					}
				}
			},
			{
				Key_u_sPackedMap, new []{
					new MaterialData
					{
						propertyType = 4,
						propertyName = "map_Pr",
						action = ((n, v, m) => mapping.FromMapPr(n, (Texture2D)v, m))
					},
					new MaterialData
					{
						propertyType = 4,
		...
		/// </summary>
		public virtual void FromMapKd(string name, Texture2D mapKd, Material property)
		{
			switch (name)
			{
				case "u_sTexture":
		...
		/// This method is generated and should not be modified.
		/// </summary>
		public virtual void FromMapPr(string name, Texture2D mapPr, Material property)
		{
			switch (name)
			{
				case "u_sPackedMap":
		...
		/// This method is generated and should not be modified.
		/// </summary>
		public virtual void FromMapD(string name, Texture2D mapD, Material property)
		{
			switch (name)
			{
				case "u_sPackedMap":
		...
		/// This method is generated and should not be modified.
		/// </summary>
		public virtual void FromBump(string name, Texture2D bump, Material property)
		{
			switch (name)
			{
				case "u_sNormalMap":
		...
		/// This method is generated and should not be modified.
		/// </summary>
		public virtual void FromNorm(string name, Texture2D norm, Material property)
		{
			switch (name)
			{
				case "u_sNormalMap":
		...
		/// <summary>
		/// Surface packed parameters. R - roughness, G - metalness, B - ao, A - unused.
		/// </summary>
